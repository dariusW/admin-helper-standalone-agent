...
public class ContextController {
	...
	@PostConstruct
	public void init() {
		System.out.println("Initiallize ContextController");
		...
		System.out.println("ContextController Ready");
	}
		...
		taskScheduler.scheduleAtFixedRate(new Runnable() {
			...
			public void run() {
				if(monitor.isEnabled()){
					client.sendPost(Client.STORE_REQ, monitor.execute(), monitor.getResponceCallback(), true);	
				}
